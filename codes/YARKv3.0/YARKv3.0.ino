...
ISR(TIMER1_COMPA_vect){//timer1 interrupt 200Hz samples gyro values and applies LQR(ts=5ms)
  ...
  theta_1=theta;
  U=constrain((K1*x + K2*x_dot + K3*(theta-2)/57.3 + K4*(theta_dot)/57.3)*255/12,-255,255);
...
//  U=(K1*x + K2*x_dot + K3*(theta)/57.3 + K4*(theta_dot)/57.3);
//  T=U*r;
//  V=T*R/km+ke*x_dot/r;
//  PWM=constrain(V*255/12,-255,255);
