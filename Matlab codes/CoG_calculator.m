...
r_arduino=105.04*10.^-3%50.27*10^-3;
r_MD=50.27*10.^-3;
r_Xb=110.04*10.^-3%170.04*10^-3
r_bat=165.04*10.^-3%51.24*10.^-3;
r_plate1=27.881*10.^-3;
r_plate2=87.655*10.^-3;
r_plate3=152.425*10.^-3;
r_uplate=207.195*10.^-3;
r_polyrod=65.095*10.^-3;
r_brassrod_l=123.73*10.^-3;
r_brassrod_s=180.92*10.^-3;
r_EM=47.43*10.^-3;
r_motors=7*10.^-3;
r_BB=35.27*10.^-3;
